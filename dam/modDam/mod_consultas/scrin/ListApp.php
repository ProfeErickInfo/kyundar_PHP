      ...
      <nav class="navbar navbar-light bg-light">
           ...
           <a class="navbar-brand">Escribe parte del nombre</a>
             <form class="d-flex" id="frmBuscar">
	              <input type="text" class="form-control" name="txtBuscar" id="txtBuscar" onkeydown="cargarB('modDam/mod_consultas/ejec/buscaListApp2.php?opbusca=1&oby=&vbusca='+this.value,'dvLista');">
             </form>
...
<div style="color:#333; height: 430px; overflow: visible;"  id="dvLista" >
...
//$result=mysqli_query($mysqli,$sql);
  ...
  ?>
   ...
   <b class="estilo-x"><?php echo $fila['nombres']." ".$fila['apellidos']; ?></b>
    <span class="badge badge-light "><a href="<?= $Href ?>" title="<?= $Comenta ?>"><img src="<?php echo $ImgEdit; ?>" alt="" width="80" height="90" border="0" /></a></span>
  </li>

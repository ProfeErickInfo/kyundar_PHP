...
////remplace id_usu
$SqlInsertDep = mysqli_query($conexion, "INSERT INTO tbx_deportistas(nombres, apellidos, tipo_doc, documento, servsalud, email, nombreEps, ano_lectivo, id_usuario, fecha_edit, fecha_nac, lugar_nac, sexo, barrio, direccion, celular, cod_int, id_club, tipo_lugar, tipo_socio, tipoDoc, docRes, responsable) VALUES(upper('".$nombre."'),upper('".$apellido."'),".$tipodoc.",'".$docu."',".$Tpsalud.",'".$email."','".$txtSalud."', ".$anoHoy.",".$id_usu.", curdate(),'".$fechaN."',".$lugarN.",".$sexo.",".$barrio.",upper('".$direccion."'),".$celular.",0, ".$idClub.", ".$OpLugar.", ".$OpSocio.", ".$tpdoc2.",'".$doc2."','".$Nacu."')");
			
///////////////////////////////////////////////////////////////////			
/*			$file = fopen("erroresEcho.txt", "a");

fwrite($file, "INSERT INTO tbx_deportistas(nombres, apellidos, tipo_doc, documento, servsalud, email, nombreEps, ano_lectivo, id_usuario, fecha_edit, fecha_nac, lugar_nac, sexo, barrio, direccion, celular, cod_int, id_club, tipo_lugar, tipo_socio, tipoDoc, docRes, responsable) VALUES(upper('".$nombre."'),upper('".$apellido."'),".$tipodoc.",'".$docu."',".$Tpsalud.",'".$email."','".$txtSalud."', ".$anoHoy.",".$id_usu.", curdate(),'".$fechaN."',".$lugarN.",".$sexo.",".$barrio.",upper('".$direccion."'),".$celular.",0, ".$idClub.", ".$OpLugar.", ".$OpSocio.", ".$tpdoc2.",'".$doc2."','".$Nacu."')" . PHP_EOL);

...
<div id="preview" class="mx-auto"  style=" background:#FFFFFF ;  overflow:auto; height:'250px'; width:'200px'; " >
...
<div class="container-fluid">
  <div class="row">
    <div class="col">
    <label for="photoimg" class="btn btn-info">
   			 <i >Capturar Foto</i> 
		</label>
		<input  type="file" onchange="previewFile()" class="form-control-file"   style="width:auto;" name="photoimg" accept="image/*"  id="photoimg"   value=<?=$pic?> />
